# Review and Reputation System: Precision Auto Care (auto service)
...
- Timing: send the first message right after pickup, while the good feeling is fresh.

## 2. The Sequence

| When | Channel | Step | Message |
|---|---|---|---|
| Trigger plus right after pickup | SMS | The Ask (1 to 5) | ~"Hi {first}, this is the service team at Precision Auto Care. Thanks for letting us help with your service. Quick one, how did we do today on a scale of 1 to 5?" |
...
| Day 1, no reply | Email | Gentle reminder | Subject: Thank you, {first} Body: ~"Thanks again for choosing Precision Auto Care for your service. If we earned it, a quick Google review would mean a lot. One tap: {{google_review_link}}. Thank you." |
...
### The Ask
```
~"Hi {first}, this is the service team at Precision Auto Care. Thanks for letting us help with your service. Quick one, how did we do today on a scale of 1 to 5?"
```
### Happy path (4 or 5)
```
...
Body: ~"Thanks again for choosing Precision Auto Care for your service. If we earned it, a quick Google review would mean a lot. One tap: {{google_review_link}}. Thank you."
```
### Final nudge
```
...
### Five star
```
~"Thank you so much, {first}. It was a pleasure helping with your service. We would love to see you again."
```
...
```
Trigger: ticket closed
Step 1: send the Ask SMS (right after pickup)
Branch on reply:
