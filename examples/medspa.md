# Review and Reputation System: Glow Aesthetics Medspa (medical spa)
...
- Timing: send the first message a few hours after the visit, while the good feeling is fresh.

## 2. The Sequence

| When | Channel | Step | Message |
|---|---|---|---|
| Trigger plus a few hours after the visit | SMS | The Ask (1 to 5) | ~"Hi {first}, this is Mia at Glow Aesthetics Medspa. Thanks for letting us help with your treatment. Quick one, how did we do today on a scale of 1 to 5?" |
...
| Day 1, no reply | Email | Gentle reminder | Subject: Thank you, {first} Body: ~"Thanks again for choosing Glow Aesthetics Medspa for your treatment. If we earned it, a quick Google review would mean a lot. One tap: {{google_review_link}}. Thank you." |
...
### The Ask
```
~"Hi {first}, this is Mia at Glow Aesthetics Medspa. Thanks for letting us help with your treatment. Quick one, how did we do today on a scale of 1 to 5?"
```
### Happy path (4 or 5)
```
...
Body: ~"Thanks again for choosing Glow Aesthetics Medspa for your treatment. If we earned it, a quick Google review would mean a lot. One tap: {{google_review_link}}. Thank you."
```
### Final nudge
```
...
### Five star
```
~"Thank you so much, {first}. It was a pleasure helping with your treatment. We would love to see you again."
```
...
```
Trigger: appointment marked complete
Step 1: send the Ask SMS (a few hours after the visit)
Branch on reply:
