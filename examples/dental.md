# Review and Reputation System: Bright Smile Dental (dental)
...
- Trigger: appointment checked out.
...
|---|---|---|---|
| Trigger plus a few hours after the visit | SMS | The Ask (1 to 5) | ~"Hi {first}, this is Avery at Bright Smile Dental. Thanks for letting us help with your visit. Quick one, how did we do today on a scale of 1 to 5?" |
...
| Day 1, no reply | Email | Gentle reminder | Subject: Thank you, {first} Body: ~"Thanks again for choosing Bright Smile Dental for your visit. If we earned it, a quick Google review would mean a lot. One tap: {{google_review_link}}. Thank you." |
...
### The Ask
```
~"Hi {first}, this is Avery at Bright Smile Dental. Thanks for letting us help with your visit. Quick one, how did we do today on a scale of 1 to 5?"
```
### Happy path (4 or 5)
```
...
Body: ~"Thanks again for choosing Bright Smile Dental for your visit. If we earned it, a quick Google review would mean a lot. One tap: {{google_review_link}}. Thank you."
```
### Final nudge
```
...
### Five star
```
~"Thank you so much, {first}. It was a pleasure helping with your visit. We would love to see you again."
```
