# Review and Reputation System: Harbor Table (restaurant)
...
- Trigger: check closed.
- Timing: send the first message the evening after the visit, while the good feeling is fresh.

## 2. The Sequence

| When | Channel | Step | Message |
|---|---|---|---|
| Trigger plus the evening after the visit | SMS | The Ask (1 to 5) | ~"Hi {first}, this is the team at Harbor Table. Thanks for letting us help with your meal. Quick one, how did we do today on a scale of 1 to 5?" |
...
| Day 1, no reply | Email | Gentle reminder | Subject: Thank you, {first} Body: ~"Thanks again for choosing Harbor Table for your meal. If we earned it, a quick Google review would mean a lot. One tap: {{google_review_link}}. Thank you." |
...
### The Ask
```
~"Hi {first}, this is the team at Harbor Table. Thanks for letting us help with your meal. Quick one, how did we do today on a scale of 1 to 5?"
```
### Happy path (4 or 5)
```
...
Body: ~"Thanks again for choosing Harbor Table for your meal. If we earned it, a quick Google review would mean a lot. One tap: {{google_review_link}}. Thank you."
```
### Final nudge
```
...
### Five star
```
~"Thank you so much, {first}. It was a pleasure helping with your meal. We would love to see you again."
```
...
```
Trigger: check closed
Step 1: send the Ask SMS (the evening after the visit)
Branch on reply:
