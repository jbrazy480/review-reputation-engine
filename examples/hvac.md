# Review and Reputation System: Summit Heating and Air (HVAC and home services)
...
- Timing: send the first message right after the job is closed out, while the good feeling is fresh.

## 2. The Sequence

| When | Channel | Step | Message |
|---|---|---|---|
| Trigger plus right after the job is closed out | SMS | The Ask (1 to 5) | ~"Hi {first}, this is Sam at Summit Heating and Air. Thanks for letting us help with the service call. Quick one, how did we do today on a scale of 1 to 5?" |
...
| Day 1, no reply | Email | Gentle reminder | Subject: Thank you, {first} Body: ~"Thanks again for choosing Summit Heating and Air for the service call. If we earned it, a quick Google review would mean a lot. One tap: {{google_review_link}}. Thank you." |
...
### The Ask
```
~"Hi {first}, this is Sam at Summit Heating and Air. Thanks for letting us help with the service call. Quick one, how did we do today on a scale of 1 to 5?"
```
### Happy path (4 or 5)
```
...
Body: ~"Thanks again for choosing Summit Heating and Air for the service call. If we earned it, a quick Google review would mean a lot. One tap: {{google_review_link}}. Thank you."
```
### Final nudge
```
...
### Five star
```
~"Thank you so much, {first}. It was a pleasure helping with the service call. We would love to see you again."
```
...
```
Trigger: job marked complete
Step 1: send the Ask SMS (right after the job is closed out)
Branch on reply:
